...
| Task ID | Task | 상태 | 설명 |
|---------|------|------|------|
| 8.2.1 | [ ] 질문 로그 테이블 생성 | 미완료 | product, question, timestamp |
| 8.2.2 | [ ] 질문 로그 저장 로직 | 미완료 | Q&A 호출 시 자동 저장 |
| 8.2.3 | [ ] 메트릭 집계 함수 | 미완료 | 총 질문 수, 제품별 질문 수, 인기 속성 |
| 8.2.4 | [ ] 사이드바 메트릭 표시 | 미완료 | 간단한 통계 카드 |
