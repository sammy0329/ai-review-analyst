...
| Task ID | Task | 상태 | 설명 |
|---------|------|------|------|
| 2.4.1 | [ ] AspectExtractor 클래스 구현 | 대기 | `src/pipeline/aspect_extractor.py` |
| 2.4.2 | [ ] 속성 추출 프롬프트 설계 | 대기 | 가격/디자인/품질/사이즈/배송 등 |
| 2.4.3 | [ ] 속성별 감정 분석 | 대기 | 속성별 긍정/부정/중립 판단 |
| 2.4.4 | [ ] 배치 처리 및 캐싱 | 대기 | 대량 리뷰 효율적 처리 |
| 2.4.5 | [ ] UI: 속성별 차트 시각화 | 대기 | 속성별 감정 분포 차트 |
| 2.4.6 | [ ] UI: 속성 필터 기능 | 대기 | 특정 속성 리뷰만 필터링 |
| 2.4.7 | [ ] UI: 제품 비교 뷰 | 대기 | 속성별 제품 간 비교 |
...
**구현 내용:**
- `src/ui/app.py`: Streamlit 대시보드 앱
- 3개 탭: 채팅, 분석, 리뷰 목록
- AI Hub 데이터 로더 통합
- RAG 기반 Q&A 채팅 (출처 표시)
- 평점 분포/감성 분석 차트
...
| Phase 2: Core RAG | 4 | 3 | 75% |
| Phase 3: Agent System | 3 | 0 | 0% |
| Phase 4: UI & Polish | 3 | 1 | 33% |
