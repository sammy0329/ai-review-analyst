...
> **목표:** 정량적 근거 강화 및 비용 효율성 표시

| Task ID | Task | 상태 | 설명 |
|---------|------|------|------|
| 8.4.1 | [ ] 프롬프트에 정량적 근거 강화 | 미완료 | "N개 중 X%가 언급" 형식 유도 |
| 8.4.2 | [ ] 응답에 비용 표시 | 미완료 | "이 답변 생성 비용: $0.002" |
| 8.4.3 | [ ] 출처 리뷰 개수 표시 | 미완료 | "12개 리뷰 참고" |

**완료 기준:** 답변에 정량적 근거 및 비용 정보 포함
...
| Phase 8: Optimization & Validation | 4 | 3 | 75% |
| **Total** | **30** | **27** | **90%** |
...
*최종 업데이트: 2026-01-15 (Epic 8.3: 시맨틱 캐싱 완료)*
